...
cy_en_ble_api_result_t Cy_BLE_Start(cy_ble_callback_t callbackFunc)
{
    ...
    /* HCI mode */
        ...
        cy_ble_config.uartIsrConfig = &BLE_PM_uart_isr_cfg;
        cy_ble_config.uartConfig = &BLE_PM_HAL_Uart_config;
        cy_ble_config.uartHw = BLE_PM_HAL_Uart_HW;
    #endif /* CY_BLE_CONFIG_STACK_MODE_CONTR_UART */
