...
/* Check for the proper BLESS ISR configuration in the DWR. */
        ...
        (!defined BLE_PM_bless_isr__INTC_CORTEXM4_ASSIGNED))
        #error Enable BLE_PM_bless_isr interrupt for the ARM CM4 core in the interrupt configuration tab of \
        ...
        (!defined BLE_PM_bless_isr__INTC_CORTEXM0P_ASSIGNED))
        #error Enable BLE_PM_bless_isr interrupt for the ARM CM0+ core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
...
/* Check for the proper UART ISR configuration in the DWR.  */
    ...
    #if((CY_BLE_CONFIG_CONTR_CORE == CY_BLE_CORE_CORTEX_M4) && \
        (!defined BLE_PM_uart_isr__INTC_CORTEXM4_ASSIGNED))
        #error Enable BLE_PM_uart_isr interrupt for the ARM CM4 core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
    #endif /* CY_BLE_CONFIG_CONTR_CORE == CY_BLE_CORE_CORTEX_M4 */
    
    #if((CY_BLE_CONFIG_CONTR_CORE == CY_BLE_CORE_CORTEX_M0P) && \
        (!defined BLE_PM_uart_isr__INTC_CORTEXM0P_ASSIGNED))
        #error Enable BLE_PM_uart_isr interrupt for the ARM CM0+ core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
    #endif /* CY_BLE_CONFIG_CONTR_CORE == CY_BLE_CORE_CORTEX_M0P */
...
/* Check for the proper HOST UART ISR configuration in the DWR.  */
        ...
        (!defined BLE_PM_host_uart_isr__INTC_CORTEXM4_ASSIGNED))
        #error Enable BLE_PM_host_uart_isr interrupt for the ARM CM4 core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
    #endif /* CY_BLE_CONFIG_HOST_CORE == CY_BLE_CORE_CORTEX_M4 */
    
    #if((CY_BLE_CONFIG_HOST_CORE == CY_BLE_CORE_CORTEX_M0P) && \
        (!defined BLE_PM_host_uart_isr__INTC_CORTEXM0P_ASSIGNED))
        #error Enable BLE_PM_host_uart_isr interrupt for the ARM CM0+ core in the interrupt configuration tab of \
            the Design-Wide Resources (DWR) file (project.cydwr)     
