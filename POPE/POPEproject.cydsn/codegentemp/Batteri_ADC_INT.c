...
*   #START and #END tags
******************************************************************************/
/* `#START Batteri_ADC_SYS_VAR`  */

/* `#END`  */

/******************************************************************************
* Function Name: Batteri_ADC_ISR
*******************************************************************************
*
...
void Batteri_ADC_ISR(void)
{
    ...
    intr_status = Cy_SAR_GetInterruptStatus(Batteri_ADC_SAR__HW);

    /* ISR Macro Callback */
    #ifdef Batteri_ADC_ISR_CALLBACK
        Batteri_ADC_ISR_Callback();
    #endif
    ...
    *************************************************************************/
    /* `#START MAIN_Batteri_ADC_ISR`  */

    /* `#END`  */

    /* Clear handled interrupt */
    Cy_SAR_ClearInterrupt(Batteri_ADC_SAR__HW, intr_status);
    /* Read interrupt status register to ensure write completed due to buffered writes */
    (void)Cy_SAR_GetInterruptStatus(Batteri_ADC_SAR__HW);
}
