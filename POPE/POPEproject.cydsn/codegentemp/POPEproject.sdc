...
# Date: Tue, 08 Dec 2020 19:38:08 GMT
#set_units -time ns
...
create_generated_clock -name {I2C_MPU6050_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 33 65} [list [get_pins {ClockBlock/ff_div_5}]]
create_generated_clock -name {UART_DEB_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 401 803} [list [get_pins {ClockBlock/ff_div_6}]]
