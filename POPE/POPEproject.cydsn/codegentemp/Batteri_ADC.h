...
#define Batteri_ADC_CFG0_VREF_SEL_MASK           (0x70u)
...
#define Batteri_ADC_CFG0_DIFFERENTIAL_FORMAT     (0uL)
#define Batteri_ADC_CFG0_SAMPLES_AVERAGED        (1uL)
...
#define Batteri_ADC_CFG0_SINGLE_PRESENT          (1)
#define Batteri_ADC_CFG0_VREF_MV_VALUE           (3300)
#define Batteri_ADC_CFG0_APERTURE_TIME0          (28uL)
...
#define Batteri_ADC_CFG0_LOW_LIMIT               (0u)
#define Batteri_ADC_CFG0_HIGH_LIMIT              (3839u)
#define Batteri_ADC_CFG0_RANGE_COND              (0uL)
#define Batteri_ADC_CFG0_USE_SOC                 (0uL)
#define Batteri_ADC_CFG0_VREF_PWR                (2uL)
