...
// bIncludeDriverToComponent_v1_0(PDL_DRIVER_NAME=ble, PDL_DRIVER_REQ_VERSION=2.0.0, PDL_DRIVER_SUBGROUP=Stack library, PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM0+, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=bIncludeDriverToComponent_v1_0, CY_CONFIG_TITLE=IncludeBleLibs, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLE_PM:IncludeBleLibs, CY_INSTANCE_SHORT_NAME=IncludeBleLibs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ble, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=Stack library, CY_PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM0+, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=BLE_PM_IncludeBleLibs, )
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=7, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=1, Period=39062, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=idleTimer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=idleTimer, CY_INSTANCE_SHORT_NAME=idleTimer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=idleTimer, )
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=1, Period=0, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=ADC_Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_Timer, CY_INSTANCE_SHORT_NAME=ADC_Timer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_Timer, )
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=1, Period=1242, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=SampleTimer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SampleTimer, CY_INSTANCE_SHORT_NAME=SampleTimer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=SampleTimer, )
...
module Scan_ADC_v3_10_7 (
	...
	cy_clock_v1_0
		#(.id("4136d59c-f58e-49f1-9eed-ebf4859e3684/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module top ;
    ...
    SCB_I2C_PDL_v2_0_4 I2C_MPU6050 (
        .clock(1'b0),
        .scl_b(Net_51),
        .scl_trig(Net_52),
        .sda_b(Net_53));

    TCPWM_Counter_PDL_v1_0_5 ADC_Timer (
        .capture(1'b0),
        .clock(Net_63),
        .compare(Net_64),
        .count(1'b1),
    ...
    TCPWM_Counter_PDL_v1_0_6 SampleTimer (
        .capture(1'b0),
        .clock(Net_72),
        .compare(Net_73),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("c11ea385-9708-4e06-a511-ce57d474b80f"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("50000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("438a52e4-6bfe-4ed5-b22f-1a0ac3f1833a"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
    ...
    Scan_ADC_v3_10_7 Batteri_ADC (
        ...
        .t_dav(Net_411),
        .t_fvalid(Net_412),
        .t_fvinternal(Net_413[1:0]),
        .t_fvout(Net_414),
        .vagnd(Net_415),
        .vinPlus_0(Net_102));

	wire [0:0] tmpFB_0__Batteri_PIN_net;
	wire [0:0] tmpIO_0__Batteri_PIN_net;
	electrical [0:0] tmpSIOVREF__Batteri_PIN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Batteri_PIN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Batteri_PIN_net[0:0]}),
		  .analog({Net_102}),
		  .io({tmpIO_0__Batteri_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__Batteri_PIN_net));


	wire [0:0] tmpFB_0__Pin_DIN_net;
	wire [0:0] tmpIO_0__Pin_DIN_net;
	electrical [0:0] tmpSIOVREF__Pin_DIN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_DIN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_DIN_net[0:0]}),
		  .io({tmpIO_0__Pin_DIN_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_DIN_net));


	wire [0:0] tmpFB_0__Pin_SCK_net;
	wire [0:0] tmpIO_0__Pin_SCK_net;
	electrical [0:0] tmpSIOVREF__Pin_SCK_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_SCK
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SCK_net[0:0]}),
		  .io({tmpIO_0__Pin_SCK_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SCK_net));
