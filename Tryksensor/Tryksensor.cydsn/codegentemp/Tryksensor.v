// ======================================================================
// Tryksensor.v generated from TopDesign.cysch
// 12/09/2020 at 13:47
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=1249, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=SampleTimer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SampleTimer, CY_INSTANCE_SHORT_NAME=SampleTimer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=SampleTimer, )
...
module top ;
	...
	wire [0:0] tmpOE__Pin_DIN_net;
	wire [0:0] tmpFB_0__Pin_DIN_net;
	wire [0:0] tmpIO_0__Pin_DIN_net;
	wire [0:0] tmpINTERRUPT_0__Pin_DIN_net;
	...
	assign tmpOE__Pin_DIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SCK_net;
	wire [0:0] tmpFB_0__Pin_SCK_net;
	wire [0:0] tmpIO_0__Pin_SCK_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SCK_net;
	...
	assign tmpOE__Pin_SCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("1e4b80a1-54f1-4e81-9a13-1ac7504541a0"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
    ...
    Timer_v2_80_2 SampleTimer (
        ...
        .tc(Net_84),
        .trigger(1'b1));
    defparam SampleTimer.CaptureCount = 2;
    defparam SampleTimer.CaptureCounterEnabled = 0;
    defparam SampleTimer.DeviceFamily = "PSoC5";
    defparam SampleTimer.InterruptOnCapture = 0;
    defparam SampleTimer.InterruptOnTC = 1;
    defparam SampleTimer.Resolution = 16;
    defparam SampleTimer.SiliconRevision = "0";
