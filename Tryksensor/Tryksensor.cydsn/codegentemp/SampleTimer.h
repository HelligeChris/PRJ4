...
#if !defined(CY_TIMER_SampleTimer_H)
#define CY_TIMER_SampleTimer_H
...
#define SampleTimer_Resolution                 16u
...
uint16  SampleTimer_ReadPeriod(void) ;
void    SampleTimer_WritePeriod(uint16 period) ;
uint16  SampleTimer_ReadCounter(void) ;
void    SampleTimer_WriteCounter(uint16 counter) ;
uint16  SampleTimer_ReadCapture(void) ;
...
#define SampleTimer_INIT_PERIOD             1249u
#define SampleTimer_INIT_CAPTURE_MODE       ((uint8)((uint8)1u << SampleTimer_CTRL_CAP_MODE_SHIFT))
...
***************************************/
    ...
    ***************************************/
    ...
    #define SampleTimer_CONTROL             (* (reg8 *) SampleTimer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define SampleTimer_CAPTURE_LSB         (* (reg8 *) SampleTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define SampleTimer_CAPTURE_LSB_PTR       ((reg8 *) SampleTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define SampleTimer_PERIOD_LSB          (* (reg8 *) SampleTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define SampleTimer_PERIOD_LSB_PTR        ((reg8 *) SampleTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define SampleTimer_COUNTER_LSB         (* (reg8 *) SampleTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define SampleTimer_COUNTER_LSB_PTR       ((reg8 *) SampleTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
    #elif(SampleTimer_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define SampleTimer_CAPTURE_LSB         (* (reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define SampleTimer_CAPTURE_LSB_PTR       ((reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define SampleTimer_PERIOD_LSB          (* (reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define SampleTimer_PERIOD_LSB_PTR        ((reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define SampleTimer_COUNTER_LSB         (* (reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
            #define SampleTimer_COUNTER_LSB_PTR       ((reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define SampleTimer_CAPTURE_LSB         (* (reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define SampleTimer_CAPTURE_LSB_PTR       ((reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define SampleTimer_PERIOD_LSB          (* (reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define SampleTimer_PERIOD_LSB_PTR        ((reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define SampleTimer_COUNTER_LSB         (* (reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
            #define SampleTimer_COUNTER_LSB_PTR       ((reg16 *) SampleTimer_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(SampleTimer_Resolution <= 24u)/* 24-bit Timer */
        #define SampleTimer_CAPTURE_LSB         (* (reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define SampleTimer_CAPTURE_LSB_PTR       ((reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define SampleTimer_PERIOD_LSB          (* (reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define SampleTimer_PERIOD_LSB_PTR        ((reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define SampleTimer_COUNTER_LSB         (* (reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define SampleTimer_COUNTER_LSB_PTR       ((reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define SampleTimer_CAPTURE_LSB         (* (reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define SampleTimer_CAPTURE_LSB_PTR       ((reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define SampleTimer_PERIOD_LSB          (* (reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define SampleTimer_PERIOD_LSB_PTR        ((reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define SampleTimer_COUNTER_LSB         (* (reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
            #define SampleTimer_COUNTER_LSB_PTR       ((reg32 *) SampleTimer_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define SampleTimer_COUNTER_LSB_PTR_8BIT       ((reg8 *) SampleTimer_TimerUDB_sT16_timerdp_u0__A0_REG )
