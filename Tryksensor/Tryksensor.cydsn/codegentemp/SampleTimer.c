...
{
   #if(SampleTimer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(SampleTimer_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG16(SampleTimer_PERIOD_LSB_PTR));
   #endif /* (SampleTimer_UsingFixedFunction) */
}
...
void SampleTimer_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(SampleTimer_PERIOD_LSB_PTR, period);
...
{
   #if(SampleTimer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(SampleTimer_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG16(SampleTimer_CAPTURE_LSB_PTR));
   #endif /* (SampleTimer_UsingFixedFunction) */
}
...
void SampleTimer_WriteCounter(uint16 counter) 
{
    ...
    #else
        CY_SET_REG16(SampleTimer_COUNTER_LSB_PTR, counter);
